<div align="center">
  ...
  <img src="https://64.media.tumblr.com/f9a888a75e3a0b3f52b0d0a7a0b3f52b_500.gif" alt="Subtle Animated Background" style="width: 100%; height: 180px; object-fit: cover; opacity: 0.05; position: absolute; top: 0; left: 0; z-index: -1; border-radius: 10px;">
</div>
...
<img src="https://raw.githubusercontent.com/AhmedAaliyan/AhmedAaliyan/main/assets/animated_divider_2.svg?raw=true" alt="Animated Divider" style="width: 100%; height: 50px; object-fit: contain; margin: 50px 0; opacity: 0.7;">
...
<img src="https://raw.githubusercontent.com/AhmedAaliyan/AhmedAaliyan/main/assets/animated_divider_3.svg?raw=true" alt="Animated Divider" style="width: 100%; height: 50px; object-fit: contain; margin: 50px 0; opacity: 0.7;">

## **📊 My GitHub Story: Dynamic Stats**

<div align="center">
  <p style="color: #7f8c8d;">Beyond the numbers, see my impact!</p>

  <img src="https://github.com/AhmedAaliyan/AhmedAaliyan/blob/main/assets/animated_heatmap.svg?raw=true" alt="Ahmed Aaliyan's Animated GitHub Contribution Heatmap" style="width: 90%; max-width: 800px; margin-top: 30px; border-radius: 8px; box-shadow: 0 4px 15px rgba(0,0,0,0.08);">

  <div style="display: flex; justify-content: space-around; margin-top: 40px; flex-wrap: wrap; gap: 20px;">
    <div style="width: 300px; height: 300px; padding: 15px; background: #fff; border-radius: 12px; box-shadow: 0 8px 25px rgba(0,0,0,0.05);">
      ...
      <p style="font-weight: bold; margin-top: 10px; color: #2c3e50;">Top Languages</p>
    </div>
    ...
    <div style="width: 300px; height: 300px; padding: 15px; background: #fff; border-radius: 12px; box-shadow: 0 8px 25px rgba(0,0,0,0.05);">
      ...
      <p style="font-weight: bold; margin-top: 10px; color: #2c3e50;">Commit Streak</p>
    </div>
  </div>
  <p style="font-style: italic; color: #95a5a6; margin-top: 20px; font-size: 0.9em;">(Data fetched and rendered dynamically via GitHub Actions)</p>
</div>

---

<img src="https://raw.githubusercontent.com/AhmedAaliyan/AhmedAaliyan/main/assets/animated_divider_4.svg?raw=true" alt="Animated Divider" style="width: 100%; height: 50px; object-fit: contain; margin: 50px 0; opacity: 0.7;">

## **💡 Currently & Learning: Real-time Insights**

<div align="center">
  <p style="color: #7f8c8d;">What's on my dev radar right now!</p>

  <div style="display: flex; justify-content: space-around; flex-wrap: wrap; margin-top: 30px; gap: 20px;">
    <div style="background: #fdfdfd; padding: 25px; border-radius: 12px; box-shadow: 0 4px 15px rgba(0,0,0,0.05); margin: 0; width: 48%;">
      <h3 style="margin-top: 0; color: #2c3e50;"><span style="margin-right: 10px;">⚡</span>Working On:</h3>
    ...
    <div style="background: #fdfdfd; padding: 25px; border-radius: 12px; box-shadow: 0 4px 15px rgba(0,0,0,0.05); margin: 0; width: 48%;">
      <h3 style="margin-top: 0; color: #2c3e50;"><span style="margin-right: 10px;">📚</span>Currently Learning:</h3>
  ...
  <h3 style="margin-top: 50px; color: #2c3e50;"><span style="margin-right: 10px;">🎧</span>Vibin' To:</h3>
  <div style="display: flex; align-items: center; background: #282828; color: #fff; padding: 15px 25px; border-radius: 12px; box-shadow: 0 6px 20px rgba(0,0,0,0.2); max-width: 450px; margin: 20px auto;">
  ...
  <p style="font-style: italic; color: #95a5a6; font-size: 0.9em;">(Powered by Spotify API via GitHub Actions - updates every ~30 mins)</p>
</div>

---

<img src="https://raw.githubusercontent.com/AhmedAaliyan/AhmedAaliyan/main/assets/animated_divider_5.svg?raw=true" alt="Animated Divider" style="width: 100%; height: 50px; object-fit: contain; margin: 50px 0; opacity: 0.7;">
...
<img src="https://raw.githubusercontent.com/AhmedAaliyan/AhmedAaliyan/main/assets/animated_divider_6.svg?raw=true" alt="Animated Divider" style="width: 100%; height: 50px; object-fit: contain; margin: 50px 0; opacity: 0.7;">
...
<div align="center">
  ...
  <p style="font-style: italic; color: #bdc3c7; margin-top: 30px; font-size: 0.85em;">(Built with passion, performance, and a keen eye for detail.)</p>
</div>
